...
def main() -> None:
    ...
    # Step 1: Build vocabulary from documents (always fresh, no counts cache)
    ...
    vocab: Vocabulary = builder.build(all_nodes, min_freq=args.vocab_min_freq)
    ...
    # Step 2: Build dataset from cached documents
    print("\n" + "=" * 60)
